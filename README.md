...
This repository contains my implementation of the MyReads app. This is the project for the
Udacity's Front End Web Development Nanodegre.
...
```
git clone https://github.com/HasanLisbon/myreads
cd myreads
```
